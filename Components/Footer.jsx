      ...
      >
        <div className="container">
          <div className="row">
            <div className="col-lg-4 col-md-12">
              ...
              <div className="footer_desc">
                ...
                >
                  ...
                  Dolorum ea est maiores omnis! Ratione repudiandae ex ducimus
                  possimus recusandae officia?
                </p>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 res_md_30 res_sm_mt_20">
              <h4
            ...
            <div className="col-lg-5 col-md-6 res_md_30 res_sm_mt_20">
          ...
          <div className="row">
            <div className="col-md-6">
              <p className="copyright">
                Copyright &copy; 2023 All Right reserved by @theblockchaincoders
              </p>
            </div>
          </div>
        </div>
