      ...
      <div className="container">
        <div className="row align-items-center">
                      ...
                      <div className="pt-3 pb-3">
                        <div className="title_dark title_border">
                          ...
                          <p>
                            ...
                            elit. Eaque, minima. Incidunt, velit ducimus natus
                            ipsa consectetur beatae vero mollitia a aliquid
                            quaerat dolorum vitae nesciunt necessitatibus
                            molestiae consequuntur? Illo tempore doloribus, in
                            laborum repellendus laboriosam qui odio assumenda
                            eveniet ea!
                          </p>
                          <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Perferendis aspernatur accusantium dignissimos
                            eum quidem eligendi vel harum officiis obcaecati
                            cupiditate. Asperiores quibusdam velit tempora
                            dolore impedit qui obcaecati odio ipsum.
                          </p>
          ...
          <div className="col-lg-6 col-md-12 col-sm-12 order-first">
            <div
              className="banner_image_right res_md_md_50 res_xs_mb_30 animation"
